...
cat("The maps are showing ICES VMS fishing hours by c-square (0.05 * 0.05 degrees) for the case study fleet per year (2021-2024). The values are only shown if there are more than 3 vessels, else the cell is coloured as grey. The bar chart below the maps is indicating the part of the fishing hours with 3 or less vessels in the case study fleet by c-square and year.")
