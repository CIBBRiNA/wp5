...
cat("Note: The maps below are only showing data where >= 3 vessels, if less than 3 vessels the area is grey")
...
cat("Note: The maps below are only showing data where >= 3 vessels, if less than 3 vessels the rectangle is grey")
