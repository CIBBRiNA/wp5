...
plot_fleet_index_var <- function(df, fleet_name, varname, base_year = 2013, title_prefix = "") {
  ...
  ggplot(df_filtered, aes(x = factor(Year))) +
    ...
    labs(title = paste("FDI effort -", title_prefix, fleet_name),
         x = "Year", y = varname) +
    theme_minimal() +
...
chart_types <- c("bar", "stacked", "heatmap", "bubble")
...
Plot 4 is showing the fishing days by vessel length categories within CS fleet at country level, where the y-axis is fixed, so it is easier to get an overview of the relative fishing effort by MS. 

Plot 5 is showing the fishing days by vessel length categories within CS fleet at country level, where the y-axis is shown as percentage.
...
Plots 1 and 2 are showing the fishing days by vessel length categories within CS fleet at EU level. 
...
The metier level 4 is defined in the DCF EU-MAP and is managed by the RCG ISSG Metier and transversal variables, and used for reporting in FDI and ICES data calls. The code has the components 'Gear'_'Target species assemblage'. See more documentation at: https://github.com/ices-eg/RCGs/tree/master/Metiers.

Note: There can be a difference between the gears reported in the GEAR_TYPE variable and in the Metier code on level 4.

As there are many minor metier codes, only the top 10 metier codes by fishing days are shown in the plot below, the rest are grouped into 'Other'.

The first plot is showing the fishing days by metier level 4 within CS fleet at EU level. 

The second plot is showing the fishing days by metier level 4 within CS fleet at country level, where the y-axis is not fixed. 

The third plot is showing the fishing days by metier level 4 within CS fleet at country level, where the y-axis is fixed, so it is easier to get an overview of the relative fishing effort by MS. 

The fourth plot is showing the fishing days by metier level 4 within CS fleet at country level, where the y-axis is shown as percentage.
...
Plot 1 shows fishing days per year and area.
Plots 2, 3 and 4 shows fishing days per vessel length and area. 2 as total, 3 with fixed y-axis and 4 as percentage.
Plots 5 and 6 shows fishing days per top 10 métier level 6 and area, as total and percentage.

```{r CS1A, fig.dim= c(6, 4)}
#plots_area <- plot_area_effort(effort_EU2, "CS1_Gillnet_North", title_prefix = "EU")
#print(plots_area[[1]])
#print(plots_area[[2]])
...
Maps by area and rectangle. Please note that the map showing effort by rectangle is not complste, as it does not include effort maked as confidential by MS.

```{r CS1area, , echo=FALSE, out.width="80%", fig.cap="1. FDI EU CS1 Northern gillnet effort, ICES areas (2023)"}

knitr::include_graphics("Q:/20-forskning/20-dfad/users/joeg/home/VMS/250318_CIBBRiNA/maps/CS1_FDI_EU_gillnets_2023_area.png")

```

```{r CS1rect, , echo=FALSE, out.width="80%", fig.cap="2. FDI EU CS1 Northern gillnet effort, ICES rectangles (2023). Please note that the effort by rectangle is not complete, as it does not include effort marked as confidential by MS"}
...
The third plot is showing the fishing days by metier level 6 within CS fleet at country level, where the y-axis is shown as percentage.
...
The third plot is showing the fishing days by metier level 5 within CS fleet at country level, where the y-axis is shown as percentage.
...
plots_area_metier <- plot_area_effort(effort_EU2, "CS2_Gillnet_Sout", group_var = "Metier", title_prefix = "EU by Metier", top_n = 10)
print(plots_area_metier[[1]])
print(plots_area_metier[[2]])
...
```{r CS2area, , echo=FALSE, out.width="80%", fig.cap="1. FDI EU CS2 Southern gillnet effort, ICES areas (2023)"}

knitr::include_graphics("Q:/20-forskning/20-dfad/users/joeg/home/VMS/250318_CIBBRiNA/maps/CS2_FDI_EU_gillnets_2023_area.png")

```

```{r CS2rect, , echo=FALSE, out.width="80%", fig.cap="2. FDI EU CS2 Southern gillnet effort, ICES rectangles (2023). Please note that the effort by rectangle is not complete, as it does not include effort marked as confidential by MS"}
...
The first plot is showing the fishing days by metier level 5 within CS fleet at country level. 

The second plot is showing the fishing days by metier level 5 within CS fleet at country level, where the y-axis is shown as percentage.
...
The first plot is showing the fishing days by metier level 4 within CS fleet at country level. 

The second plot is showing the fishing days by metier level 4 within CS fleet at country level, where the y-axis is shown as percentage.
...
The third plot is showing the fishing days by metier level 4 within CS fleet at country level, where the y-axis is shown as percentage.
...
```{r CS4area, , echo=FALSE, out.width="80%", fig.cap="1. FDI EU CS4 Longlines effort, ICES areas (2023)"}
...
```{r CS4rect, , echo=FALSE, out.width="80%", fig.cap="2. FDI EU CS4 Longlines effort, ICES rectangles (2023). Please note that the effort by rectangle is not complete, as it does not include effort marked as confidential by MS"}
...
```{r CS7area, , echo=FALSE, out.width="80%", fig.cap="1. FDI EU CS7 Pelagic trawl effort, ICES areas (2023)"}
...
```{r CS7rect, , echo=FALSE, out.width="80%", fig.cap="2. FDI EU CS7 Pelagic trawl effort, ICES rectangles (2023). Please note that the effort by rectangle is not complete, as it does not include effort marked as confidential by MS"}
...
```{r CS8area, , echo=FALSE, out.width="80%", fig.cap="1. FDI EU CS8 Demersal trawl effort, ICES areas (2023)"}
...
```{r CS8rect, , echo=FALSE, out.width="80%", fig.cap="2. FDI EU CS8 Demersal trawl effort, ICES rectangles (2023). Please note that the effort by rectangle is not complete, as it does not include effort marked as confidential by MS"}
